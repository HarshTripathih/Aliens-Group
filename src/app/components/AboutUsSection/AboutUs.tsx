...
const revealVariant = {
  ...
  return (
    ...
    {/* Animated lines */}
                ...
                {/* Left golden line */}
                <motion.div
                  className="absolute top-[6rem] left-[25rem] 2xl:left-[35rem] h-[1px] bg-gradient-to-r from-[#80808040] to-[#B57F12CC] origin-left z-10"
                ...
                {/* Right golden line */}
                <motion.div
                  className="absolute top-[6rem] right-[25rem] 2xl:right-[35rem] h-[1px] bg-gradient-to-r from-[#B57F12CC] to-[#80808040] origin-right z-10"
                ...
                <motion.div
                  className="absolute top-[6rem] left-[25rem] 2xl:left-[35rem] h-[1px] bg-white z-20 origin-right"
                  style={{ width: '21%' }}
                ...
                <motion.div
                  className="absolute top-[6rem] right-[25rem] 2xl:right-[35rem] h-[1px] bg-white z-20 origin-left"
                  style={{ width: '21%' }}
